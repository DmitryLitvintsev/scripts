...
set title 'Migration of T10K media, monthly volume'

D0 = 'data/d0_writes_monthly.data'
CDF = 'data/cdf_writes_monthly.data'
CMS = 'data/cms_writes_monthly.data'
PUBLIC = 'data/public_writes_monthly.data'
